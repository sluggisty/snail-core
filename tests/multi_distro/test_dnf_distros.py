...
class TestDnfDistros(unittest.TestCase):
    ...
    def test_fedora_detection_uses_dnf(self):
        ...
        with patch.object(self.collector, "detect_distro", return_value={"id": "fedora", "version": "39"}), \
    ...
    def test_rhel_8_detection_uses_dnf(self):
        ...
        with patch.object(self.collector, "detect_distro", return_value={"id": "rhel", "version": "9.0"}), \
             patch.object(self.collector, "run_command") as mock_run:
    ...
    def test_centos_stream_detection_uses_dnf(self):
        ...
        with patch.object(self.collector, "detect_distro", return_value={"id": "centos", "version": "9"}), \
             patch.object(self.collector, "run_command") as mock_run:
