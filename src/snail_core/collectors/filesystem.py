    ...
    def _get_mounts(self) -> list[dict[str, Any]]:
        ...
        for line in self.read_file_lines("/proc/mounts"):
            ...
            if len(parts) >= 4:
                ...
                if fstype in ("proc", "sysfs", "devpts", "cgroup", "cgroup2", 
                              "securityfs", "debugfs", "tracefs", "fusectl",
                              "configfs", "pstore", "efivarfs", "bpf"):
                    continue
